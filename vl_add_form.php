		...
		<div  id="second_sidebar" class="column sidebar span3">
			...
			<div id="content" class="column span9">
						...
						if(isset($_POST['doSubmit']) and($_POST['doSubmit'] == 'Enregistrer'))
							...
							mysqli_query($link, "INSERT INTO `dhappdatabase`.`viralLoad` (`id`, `serialNumber`, `dateOfOrder`,`dateOfsample`, `dateOfresult`, `vlCount`) VALUES ('','$post[serialNumber]','$post[dateOfOrder]','$post[dateOfsample]','$post[dateOfresult]','$post[vlCount]')");
							$linkU="patient_followup_sheet.php?Code=".$post[serialNumber];
							redir($linkU);
							
							} ?>
								  
								  <h3 class="titlehdr">Enregistrer une Charge Virale</h3>
								  <table width="80%" border="0" cellpadding="5" cellspacing="2" class="myaccount">
									<tr>
									  <td><form name="vl_add_form" method="post" action="vl_add_form.php">									
																...
																<table style="width:100%;"  border=0>			
																	<tr>
																		...
																		<td width=30%>																		
																			...
																			<input name="dateOfOrder" type="date" id="dateOfOrder" >																		
																		</td>
																		<!-- dateOfOrder -->																	
																		<!-- dateOfsample -->																		
																		<td width=30%>																		
																		...
																		<td width=30%>																		
																			Nombre de copie										
																			<input name="vlCount" type="number" id="vlCount" >																		
																		</td>
																		<!-- dateOfresult -->
																	</tr>
																</table>
