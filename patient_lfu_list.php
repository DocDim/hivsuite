...
<html> 
<head>
<title>Liste des Perdus de vue</title>
		...
		<div id="main" class="row-fluid">
			...
			<div id="content" class="column span9">
			  ...
			  <div id="printableArea">
						...
						<span style="font-size: 36px;"><strong><h3 class="titlehdr">Liste des Perdus de vue</h3></strong></span>
						</div>	
													
					<?php 
												  
						$sql = "select * from `dhappdatabase`.`patient` where (TO_DAYS(DATE(NOW()))-TO_DAYS(DATE(nextVisit))>90)"; 
