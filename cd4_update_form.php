...
$sql = "SELECT * FROM `dhappdatabase`.`cd4`  WHERE `id`= '$Code' ";
		...
		<div  id="second_sidebar" class="column sidebar span3">
			...
			<div id="content" class="column span9">
						...
						if(isset($_POST['doSubmit']) and($_POST['doSubmit'] == 'Modifier'))
							...
							mysqli_query($link, "UPDATE `dhappdatabase`.`cd4` 
										SET `dateOfsample`='$post[dateOfsample]', `dateOfresult`='$post[dateOfresult]', `cd4Count`='$post[cd4Count]'
										WHERE id='$post[id]'");
								  ...
								  <h3 class="titlehdr">Modifier un CD4</h3>
								  <table width="80%" border="0" cellpadding="5" cellspacing="2" class="myaccount">
									<tr>
									  <td>
										<form name="cd4_add_form" method="post" action="cd4_update_form.php">
															...
															<fieldset>
																...
																<table style="width:100%;"  border=0>			
																	<tr>																	
																		...
																		<td width=30%>																		
																			Valeur									
																			<input name="cd4Count" type="number" id="cd4Count" value="<?php echo $cd4Count;?>" >																		
																		</td>
																		<!-- cd4Count -->
																	</tr>
																</table>
