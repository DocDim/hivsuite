		...
		<div  id="second_sidebar" class="column sidebar span3">
			...
			<div id="content" class="column span9">
						...
						if(isset($_POST['doSubmit']) and($_POST['doSubmit'] == 'Modifier'))
							...
							mysqli_query($link, "UPDATE `dhappdatabase`.`vitalParameter` 
										SET `serialNumber`='$post[serialNumber]', `height`='$post[height]', `weight`='$post[weight]', `bmi`='$post[bmi]', `temperature`='$post[temperature]', `bloodPressure`='$post[bloodPressure]', `pulseRate`='$post[pulseRate]', `respirationRate`='$post[respirationRate]'
										WHERE id='$post[id]'");
								  ...
								  <table width="80%" border="0" cellpadding="5" cellspacing="2" class="myaccount">
									<tr>
									  <td>
										<form name="vitalParameter_update_form" method="post" action="vitalParameter_update_form.php">
